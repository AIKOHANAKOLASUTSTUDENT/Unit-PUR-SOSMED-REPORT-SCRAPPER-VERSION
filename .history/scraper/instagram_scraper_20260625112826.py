...
class InstagramScraper:
    ...
    def _shortcode_to_mediaid(self, shortcode: str) -> str:
    ...
    def _scrape_meta_api(self, url: str, route_type: str = "Post") -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.debug(f"Converted shortcode to media_id={media_id}")
        except ValueError as e:
            self.logger.warning(f"Could not convert shortcode to media_id for {url}: {e}")
            return record
