...
META_API_VERSION = _get_env("META_API_VERSION") or "v21.0"
META_INSTAGRAM_ID = _get_env("META_INSTAGRAM_ID") or "26624746820536132"
META_APP_ID = _get_env("META_APP_ID") or "1314260764021343"
META_APP_SECRET = _get_env("META_APP_SECRET") or "2cf9e24b368b9a89f431f526c19ae39d"

if META_ACCESS_TOKEN:
    SCRAPER_STRATEGY = "meta"
    logging.getLogger(__name__).info("Auto-switching to Meta API because META_ACCESS_TOKEN is set")

if SCRAPER_STRATEGY not in ["instaloader", "apify", "meta"]:
...
if SCRAPER_STRATEGY == "apify" and not APIFY_TOKEN:
    import warnings
    warnings.warn(
        "APIFY_TOKEN is not set. Apify scraping will fail until configured."
    )
