...
class SpreadsheetService:
    ...
    def ensure_header(self) -> None:
        ...
        headers = [
            "No", "Bulan", "Tanggal yang post date", "Judul Konten", "Link IG",
    ...
    def get_existing_urls(self) -> Set[str]:
        ...
        try:
            # Get all values in URL column (column A, starting from row 2)
    ...
    def append_rows(self, records: List[Dict]) -> int:
        ...
        for record in records:
            ...
            try:
                bulan = post_date.split(" ")[0].split("-")[1] if post_date and post_date != "N/A" else ""
            except Exception:
                bulan = ""
